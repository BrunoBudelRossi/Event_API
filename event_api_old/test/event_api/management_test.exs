defmodule EventApi.ManagementTest do
  ...
  describe "events" do
    ...
    @valid_attrs %{day: ~D[2010-04-17], description: "some description", title: "some title"}
    @update_attrs %{day: ~D[2011-05-18], description: "some updated description", title: "some updated title"}
